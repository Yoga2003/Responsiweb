...
import WatermelonJSON from "/public/img/floridina.json";
    ...
    <nav class="bg-white">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/" class="flex items-center">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-dark">Floridina Orange</span>
            </a>
    ...
    <section cclass="bg-grey-50" id="about">
        <div class="mx-auto max-w-screen-xl container flex flex-col items-center py-16 md:py-20 lg:flex-row">
            <div class="w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left">
                <h2 class="font-header text-4xl font-semibold uppercase text-primary sm:text-5xl lg:text-6xl"> Minuman Nyegerin
                </h2>
                ...
                <div class="flex flex-col justify-center pt-6 sm:flex-row lg:justify-start">
                    <div class="flex items-center justify-center sm:justify-start">
                        <a href="https://www.instagram.com/mujiyantosvc/"
                            class="font-body text-lg font-semibold uppercase text-grey-20"> Floridina, so fresh, so juicy! </a>
